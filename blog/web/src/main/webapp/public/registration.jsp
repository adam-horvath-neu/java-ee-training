...
<body>
	...
	<div class="container">
		...
		<div class="row">
			<form class="form-signin" name = "myform" id= "myform" action="<c:url value="/SignUp" ></c:url>" method="post">
				...
				<button class="btn btn-lg btn-primary btn-block" type="submit" id= "bt" name="bt" value = "sign-up">Sign up</button>	
