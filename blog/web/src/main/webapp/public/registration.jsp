		...
		<div class="row">
			<form class="form-signin" action="<c:url value="/register" ></c:url>"
				...
				<label for="inputUsername" class="sr-only">Username</label> <input
					...
					class="form-control" placeholder="First name" required> <input
					...
					placeholder="Email address" required> <input type="text"
					name="phone" id="inputPhone" class="form-control"
					placeholder="Phone number" required> <input type="text"
					name="Picture" id="inputPicture" class="form-control"
					placeholder="Picture" required> <input type="password"
					name="password" id="inputPassword" class="form-control"
					placeholder="Password" required> <input type="password"
					name="password2" id="inputPassword2" class="form-control"
