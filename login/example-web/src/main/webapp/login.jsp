	...
	<div class="container">
		...
		<div class="row">
			<form class="form-signin" action="<c:url value="/Login" ></c:url>" method="post">
				...
				<button class="btn btn-lg btn-primary btn-block" name = "bt" value="in" type="submit">Sign
					in</button>
				
			</form>
			<form class="form-signin" action="<c:url value="/Login" ></c:url>" method="post">
			<button class="btn btn-lg btn-primary btn-block" type="submit" name="bt" value = "sign-up">Sign up</button>	
		</form>
		</div>
