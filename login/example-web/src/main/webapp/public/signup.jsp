	...
	<div class="container">
		...
		<div class="row">
			<form class="form-signin"
				...
				<input type="password" name="passwordagain" id="inputPassword2"
				...
				<input type="text" name="secondname" id="inputLastName"
				...
				<input type="text" name="phonenumber" id="inputPhone" class="form-control"
					placeholder="Phone number" required> 
				
				<label for="inputPicture" class="sr-only">Profile picture</label>
				<input type="text" name="pictureurl" id="inputPicture"
					class="form-control" placeholder="Picture URL" required>
