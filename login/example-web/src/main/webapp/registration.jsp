			...
			.ready(
					function() {
								...
								.validate(
										{
											...
											messages : {
												email : {
													required : "REQUIRED",
													email : "For example: example@example.com"
												},
												firstname : {
											...
											invalidHandler : function() {
												alert('Add your all valid datas!');
											}
										});
						$("#myform2")
								.validate(
						...
						function passwordsMatch() {
							return $('#password').val() == $('#passwordagain')
									.val();
						}
						$("#passwordagain").keyup(
								function() {
						...
						function passwordsMatchu() {
							return $('#upassword').val() == $('#upasswordagain')
									.val();
						}
						$("#upasswordagain").keyup(
								function() {
									if (!passwordsMatchu()) {
					...
					<tr>
						<td><a href="#" id="dialog-link"
							class="ui-state-default ui-corner-all"><span
								class="ui-icon ui-icon-newwin"></span>Registration</a>
						<td>
						<td><a href="#" id="delete"
							class="ui-state-default ui-corner-all"><span
			...
			<table>
				...
				<tr>
					...
					<td><input id="passwordagain" type="password"
						name="passwordagain" onChange="checkPasswordMatch();"></td>
	...
	<div id="udialog" title="UPDATE">
		<form id="myform2">
			<table>
				...
				<tr>
					<td>Password</td>
					<td><input id="upassword" type="password" name="password"
						onChange="checkPasswordMatch();"></td>
				</tr>
				<tr>
					<td>Re-Password</td>
					<td><input id="upasswordagain" type="password"
						name="passwordagain" onChange="checkPasswordMatch();"></td>
