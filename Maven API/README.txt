...
A jegyeket id-val azonosítjuk, tehát ezt kell bekérni a felhasználótól. Ezt követően kérjük be, hogy milyen eladón keresztül, és milyen fizetési móddal szeretné megvenni a jegyet. (A bekérés hasonlóan történjen, mint a felhasználónév és jelszó bekérése).
...
Implementáljuk a booking-core-ban a BookingService interfészt, és valósítsuk meg.
...
A maven-multimodule-web készítsünk a ServiceLocator osztályba egy új metódust, ami a BookinService interfészhez visszaadja nekünk a hozzá tartozó implementációt. Hasonlóan az getDatabaseAuthenticatorService() és getLDAPAuthenticatorService()-hez. Ezen keresztül hívjuk meg a web-ről a megfelelő metódusokat.
